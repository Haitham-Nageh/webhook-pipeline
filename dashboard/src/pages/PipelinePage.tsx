      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <p className="font-mono text-xs text-blue-400 bg-gray-800 px-3 py-2 rounded-md flex-1 truncate">
                  {webhookUrl}
                </p>
                <button
                  onClick={handleCopy}
                  className="px-3 py-2 bg-gray-800 hover:bg-gray-700 text-gray-400 rounded-md text-xs transition-colors whitespace-nowrap">
                  {copied ? "Copied" : "Copy"}
                </button>
              </div>
            </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full bg-white text-gray-900 hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed py-2 rounded-md text-sm font-medium transition-colors">
            {sending ? "Sending..." : "Send Webhook"}
          </button>

          {!pipeline.isActive && (
            <p className="text-yellow-400 text-xs text-center">
              Pipeline is inactive — activate it first
            </p>
          )}
